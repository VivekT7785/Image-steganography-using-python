...
def encode():
	...
	LabelTitle=Label(text="ENCODE",bg="green",fg="white",width=20)
	...
	def openfile():
		...
		Labelpath.place(relx=0.8, rely=0.8, height=18, width=450)
	...
	Button2.place(relx=0.7, rely=0.2, height=40, width=94)
...
def decode():
	...
	LabelTitle=Label(text="DECODE",bg="black",fg="white",width=20)
	LabelTitle['font']=fontl
	LabelTitle.place(relx=0.6, rely=0.1)
...
encbutton=Button(text='Encode',fg="white",bg="green",width=20,command=encode)
